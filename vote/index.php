...
<div class="catalin-header">
          ...
          <div class="cutie-3" id="cutie-3">
            <a href="#" style="text-decoration: none;" id="copiazaIP">
              ...
              <ul class="directia-elementelor-secundare" style="margin-right: 0px;">
                <li class="element-secundar"><h3 class="play-button-design"><span class="player-count">?</span> players online</h3></li>
      ...
      <div class="vote-content">
        ...
        <div class="vote-medium-box" id="vote-medium-box">
          <div class="vote-medium-box-header">
            <h3><i class="fas fa-hand-spock"></i> Vote Links </h3>
          </div>
    ...
    <div class="footer">
      ...
      <p>© 2019 <?php echo $server_copyright; ?>. All Rights Reserved.</p>
      <p>Made by <a href="https://discord.gg/4JmzQJe">Catalin</a></p>
