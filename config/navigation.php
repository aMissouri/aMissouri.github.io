...
function redirectionari_navigatie() {
  ...
  $navigatie[5] = "Updates"; # $navigatie[number] is number of navigation link
  ...
  $navigatie[6] = "Test"; # $navigatie[number] is number of navigation link
  $navigatie_links[6] = "test"; # $navigatie_links[number] is number of navigation link
